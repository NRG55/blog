...
const Navbar = () => {
    ...
    return (
        <nav className="z-10 sticky top-0 flex item-center gap-12 w-full px-[5vw] py-5 border-b border-gray-100 bg-white">
            ...
            <div className={"absolute bg-white w-full left-0 top-full mt-0.5 border-b border-gray-100 py-2 px-[5vw] md:block md:relative md:opacity-100 md:pointer-events-auto md:inset-0 md:mt-0 md:border-0 md:p-0 md:w-auto " + (
