        ...
        <footer className="bg-black text-gray-400 py-12 px-[5vw] border-t border-gray-900">
            <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
               <div className="space-y-4">
                    <Link to="/posts" className="flex items-center gap-1 group">
                    ...
                    <p className="text-sm leading-relaxed max-w-50">
                         A workspace to create, edit, and publish posts.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <ul className="space-y-3 text-sm">
                        ...
                        <li>
                            <Link to="/comments" className="hover:text-white transition">
                                Comments
                            </Link>
                        </li>

                        <li>
                            <Link to="/posts/create" className="hover:text-white transition">
                                New post
                            </Link>
                        </li>
